...
export default function BuildingsMenu({ items }: { items: Item[] }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div role="menu" style={{ transformOrigin: 'top left' }} className="menu-in absolute left-0 z-50 mt-2 w-56 overflow-hidden rounded-lg border border-[var(--color-border-default)] bg-surface-card shadow-2xl">
          {items.map((b) => (
