...
export const buildings: BuildingMeta[] = [
  {
    ...
    landmarks: [
      { id: 'myKheBeach', name: { en: 'My Khe Beach', vi: 'Bãi biển Mỹ Khê', ko: '미케 해변', 'zh-Hans': '美溪海滩', ru: 'Пляж Мьякхе' }, distance: '0.4 km' },
      { id: 'dragonBridge', name: { en: 'Dragon Bridge', vi: 'Cầu Rồng', ko: '드래곤 브리지', 'zh-Hans': '龙桥', ru: 'Мост Дракон' }, distance: '1.7 km' },
      { id: 'hanRiverBridge', name: { en: 'Han River Bridge', vi: 'Cầu Sông Hàn', ko: '한강교', 'zh-Hans': '韩江桥', ru: 'Мост через реку Хан' }, distance: '2.4 km' },
      { id: 'cathedral', name: { en: 'Da Nang Cathedral', vi: 'Nhà thờ Đà Nẵng', ko: '다낭 대성당', 'zh-Hans': '岘港大教堂', ru: 'Кафедральный собор Дананга' }, distance: '3.0 km' },
      { id: 'railwayStation', name: { en: 'Da Nang Railway Station', vi: 'Ga Đà Nẵng', ko: '다낭 기차역', 'zh-Hans': '岘港火车站', ru: 'Железнодорожный вокзал Дананга' }, distance: '4.5 km' },
      { id: 'airport', name: { en: 'Da Nang International Airport (DAD)', vi: 'Sân bay Quốc tế Đà Nẵng (DAD)', ko: '다낭 국제공항 (DAD)', 'zh-Hans': '岘港国际机场 (DAD)', ru: 'Международный аэропорт Дананга (DAD)' }, distance: '5.0 km' },
      { id: 'marbleMountains', name: { en: 'Marble Mountains (Ngũ Hành Sơn)', vi: 'Ngũ Hành Sơn', ko: '마블 마운틴 (응우한선)', 'zh-Hans': '五行山', ru: 'Мраморные горы (Нгуханьшон)' }, distance: '6.5 km' },
    ],
    rooms: [
